...
SCREENS = {
    ...
    # AX 도입 관리 > 카테고리 목록 관리 (PD05)
    '카테고리목록': dict(id='KTAX-AD-PD05-1000', title='AX 도입 관리 > 카테고리 목록 관리 > 목록',
                   path='Admin > AX 도입 관리 > 카테고리 목록 관리', src='samples/admin/KTAX-AD-PD05-1000.src.html'),
    '카테고리등록': dict(id='KTAX-AD-PD05-2000', title='AX 도입 관리 > 카테고리 목록 관리 > 등록',
                   path='Admin > AX 도입 관리 > 카테고리 목록 관리 > 등록', src='samples/admin/KTAX-AD-PD05-2000.src.html'),
    '카테고리상품선택팝업': dict(id='KTAX-AD-PD05-2100', title='카테고리 목록 관리 > 상품 선택 팝업',
                   path='Admin > AX 도입 관리 > 카테고리 목록 관리 > 상품 선택 팝업', src='samples/admin/KTAX-AD-PD05-2100.src.html'),
    '카테고리수정': dict(id='KTAX-AD-PD05-3000', title='AX 도입 관리 > 카테고리 목록 관리 > 상세/수정',
                   path='Admin > AX 도입 관리 > 카테고리 목록 관리 > 상세/수정', src='samples/admin/KTAX-AD-PD05-3000.src.html'),
    # 도입사례 관리 (UC01)
    '도입사례목록': dict(id='KTAX-AD-UC01-0000', title='도입사례 관리 > 도입사례 > 목록',
                   path='Admin > 도입사례 관리 > 도입사례', src='samples/admin/KTAX-AD-UC01-0000.src.html'),
    '도입사례등록': dict(id='KTAX-AD-UC01-1000', title='도입사례 관리 > 도입사례 > 등록',
                   path='Admin > 도입사례 관리 > 도입사례 > 등록', src='samples/admin/KTAX-AD-UC01-1000.src.html'),
    '도입사례상품선택팝업': dict(id='KTAX-AD-UC01-1100', title='도입사례 관리 > 상품 선택 팝업',
                   path='Admin > 도입사례 관리 > 도입사례 > 상품 선택 팝업', src='samples/admin/KTAX-AD-UC01-1100.src.html'),
    '도입사례수정': dict(id='KTAX-AD-UC01-2000', title='도입사례 관리 > 도입사례 > 상세/수정',
                   path='Admin > 도입사례 관리 > 도입사례 > 상세/수정', src='samples/admin/KTAX-AD-UC01-2000.src.html'),
    # 인사이트 관리 (IS01)
    '인사이트목록': dict(id='KTAX-AD-IS01-0000', title='인사이트 관리 > 인사이트 > 목록',
                   path='Admin > 인사이트 관리 > 인사이트', src='samples/admin/KTAX-AD-IS01-0000.src.html'),
    '인사이트등록': dict(id='KTAX-AD-IS01-1000', title='인사이트 관리 > 인사이트 > 등록',
                   path='Admin > 인사이트 관리 > 인사이트 > 등록', src='samples/admin/KTAX-AD-IS01-1000.src.html'),
    '인사이트상품선택팝업': dict(id='KTAX-AD-IS01-1100', title='인사이트 관리 > 상품 선택 팝업',
                   path='Admin > 인사이트 관리 > 인사이트 > 상품 선택 팝업', src='samples/admin/KTAX-AD-IS01-1100.src.html'),
    '인사이트수정': dict(id='KTAX-AD-IS01-2000', title='인사이트 관리 > 인사이트 > 상세/수정',
                   path='Admin > 인사이트 관리 > 인사이트 > 상세/수정', src='samples/admin/KTAX-AD-IS01-2000.src.html'),
    # 이벤트 관리 (EV01 / EV02)
    '이벤트목록': dict(id='KTAX-AD-EV01-0000', title='이벤트 관리 > 이벤트 > 목록',
                   path='Admin > 이벤트 관리 > 이벤트', src='samples/admin/KTAX-AD-EV01-0000.src.html'),
    '이벤트등록': dict(id='KTAX-AD-EV01-1000', title='이벤트 관리 > 이벤트 > 등록',
                   path='Admin > 이벤트 관리 > 이벤트 > 등록', src='samples/admin/KTAX-AD-EV01-1000.src.html'),
    '이벤트수정': dict(id='KTAX-AD-EV01-2000', title='이벤트 관리 > 이벤트 > 상세/수정',
                   path='Admin > 이벤트 관리 > 이벤트 > 상세/수정', src='samples/admin/KTAX-AD-EV01-2000.src.html'),
    '사전등록신청목록': dict(id='KTAX-AD-EV02-0000', title='이벤트 관리 > 사전등록 신청 > 목록',
                   path='Admin > 이벤트 관리 > 사전등록 신청', src='samples/admin/KTAX-AD-EV02-0000.src.html'),
    '사전등록신청상세': dict(id='KTAX-AD-EV02-1000', title='이벤트 관리 > 사전등록 신청 > 상세',
                   path='Admin > 이벤트 관리 > 사전등록 신청 > 상세', src='samples/admin/KTAX-AD-EV02-1000.src.html'),
}
